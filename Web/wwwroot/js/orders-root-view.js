(function(global){
  ...
  function create(options){
    ...
    function clearSession(){orders=[];reservations=[];ordersNextCursor=null;ordersHasMore=false;orderClinics={};ordersCalendarByDate=new Map();ordersCalendarCapacityByDate=new Map();ordersCalendarWeeklyCapacityByDate=new Map();clearFindHighlight();setOrdersCalendarHighlight(null)}
