(function(global){
  ...
  function constructionLabel(c){ return ({crown:'Корона',bridge:'Мост',inlayOverlay:'Инлей/Онлей'})[c] || 'Конструкция'; }
  ...
  function statusText(s){ return s==='cancelled'?'Отказана':s==='created'?'Изпратена':(s||'Изпратена'); }
  ...
  function orderMaterialShort(o){ return ({fullContourZirconia:'Zr',pfzLayeredZrCrown:'Послоен Zr',pfm:'Металокерамика',glassCeramics:'SiLi',pmma:'PMMA-S',pmmaTelio:'PMMA-T'})[o.material] || titleText(o.material) || 'Материал'; }
  ...
  function orderOverviewShadeLine(o){ return o.shade&&o.shade!=='unspecified' ? `цвят ${o.shade}` : ''; }
