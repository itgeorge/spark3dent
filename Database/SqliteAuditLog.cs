...
public sealed class SqliteAuditLog : IAuditLog
{
    ...
    private static AuditEventEntity ToEntity(AuditEvent auditEvent) => new()
    {
        ...
        ActorOrganizationType = auditEvent.ActorOrganizationType,
        ActorOrganizationCode = auditEvent.ActorOrganizationCode,
        ActorMemberId = auditEvent.ActorMemberId,
        ActorMemberLabel = auditEvent.ActorMemberLabel,
